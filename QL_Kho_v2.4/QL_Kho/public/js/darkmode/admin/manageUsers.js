...
darkModeToggle.addEventListener('click', () => {
    ...
    if (addUserButton) addUserButton.classList.toggle('dark-mode'); // Sử dụng class 'darkmode'
    if (userTable) {
...
if (localStorage.getItem('darkMode') === 'true') {
    ...
    if (addUserButton) addUserButton.classList.add('dark-mode'); // Sử dụng class 'darkmode'
    if (userTable) {
